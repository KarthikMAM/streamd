...
import { assertHasInput, assertNoDeprecatedOption, assertStringChunk } from "./validation";
 ...
 * @throws {@link StreamdReactNativeArgumentError} (kind `"deprecated-option"`)
 *   when `allowDangerousMetaHtml` is passed.
 */
export function StreamdMarkdownNative(props: StreamdMarkdownNativeProps): ReactNode {
  assertNoDeprecatedOption(props as Record<string, unknown>, "StreamdMarkdownNative");
